...
<li class="erm_product specials-item <?php echo ( ($has_thumbnail && $show_thumbnails) ? 'with_image' : 'no_image'); ?>">
    ...
    <h3 class="erm_product_title_special"><?php echo $the_post->post_title;?>
