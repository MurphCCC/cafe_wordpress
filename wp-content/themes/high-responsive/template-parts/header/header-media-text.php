...
<?php
$header_media_title = get_theme_mod( 'highresponsive_header_media_title', esc_html__( 'Welcome to High Responsive', 'highresponsive' ) );

$header_media_text = get_theme_mod( 'highresponsive_header_media_text', esc_html__( 'Make things as simple as possible but no simpler.', 'highresponsive' ) );
