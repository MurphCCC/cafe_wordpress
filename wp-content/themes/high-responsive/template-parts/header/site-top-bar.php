...
<?php
	$search_text = get_theme_mod( 'highresponsive_search_text', esc_html__( 'Search', 'highresponsive' ) );
?>
	...
	<div class="wrapper">
			...
			<?php if( get_theme_mod( 'highresponsive_enable_date' ) || get_theme_mod( 'highresponsive_email' ) || get_theme_mod( 'highresponsive_phone' ) ): ?>
				<div class="header-top-left">
            		<ul class="contact-details">
						...
						<li class="contact-email"><a href="<?php echo esc_attr( antispambot( get_theme_mod( 'highresponsive_email' ) ) ); ?>"><?php echo highresponsive_get_svg( array( 'icon' => 'envelope-o' ) ); ?><?php echo esc_html( antispambot( get_theme_mod( 'highresponsive_email' ) ) ) ?></a></li>
						<?php endif; ?>

						<?php if ( get_theme_mod( 'highresponsive_phone' ) ) : ?>
						<li class="contact-phone"><a href="tel:' . esc_attr( preg_replace( '/\s+/', '', get_theme_mod( 'highresponsive_phone' ) ) ) . '"><?php echo highresponsive_get_svg( array( 'icon' => 'phone' ) ); ?><?php echo esc_html( preg_replace( '/\s+/', '', get_theme_mod( 'highresponsive_phone' ) ) ); ?></a></li>
						<?php endif; ?>
					</ul><!-- .contact-details -->
				</div><!-- .header-top-left -->
        	<?php endif; ?>
    	...
    	<?php if ( has_nav_menu( 'social-top' ) ) : ?>
    		<div class="header-top-right top-without-menu">
				<nav id="social-navigation" class="social-navigation" role="navigation" aria-label="<?php esc_attr_e( 'Social Links Menu', 'highresponsive' ); ?>">
					<?php
						wp_nav_menu( array(
