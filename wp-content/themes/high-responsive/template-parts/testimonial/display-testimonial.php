...
$jetpack_defaults = array(
	'page-title' => esc_html__( 'Testimonials', 'highresponsive' ),
);

// Get Jetpack options for testimonial.
$jetpack_options = get_theme_mod( 'jetpack_testimonials', $jetpack_defaults );

$headline = isset( $jetpack_options['page-title'] ) ? $jetpack_options['page-title'] : esc_html__( 'Testimonials', 'highresponsive' );
		...
		<div class="section-content-wrap">
			...
			<div class="cycle-slideshow"
				...
				<button class="cycle-prev" aria-label="Previous">
					<span class="screen-reader-text"><?php esc_html_e( 'Previous Slide', 'highresponsive' ); ?></span><?php echo highresponsive_get_svg( array( 'icon' => 'angle-down' ) ); ?>
				</button>

				<button class="cycle-next" aria-label="Next">
					<span class="screen-reader-text"><?php esc_html_e( 'Next Slide', 'highresponsive' ); ?></span><?php echo highresponsive_get_svg( array( 'icon' => 'angle-down' ) ); ?>
				</button>
