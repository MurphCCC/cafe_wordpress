	...
	*/
	public function show() {
		...
		$sidebar_options = array(
			'default-sidebar'        => esc_html__( 'Default Sidebar', 'highresponsive' ),
			'optional-sidebar-one'   => esc_html__( 'Optional Sidebar One', 'highresponsive' ),
			'optional-sidebar-two'   => esc_html__( 'Optional Sidebar Two', 'highresponsive' ),
			'optional-sidebar-three' => esc_html__( 'Optional Sidebar three', 'highresponsive' ),
		);

		$header_image_options 	= array(
			'default' => esc_html__( 'Default', 'highresponsive' ),
			'enable'  => esc_html__( 'Enable', 'highresponsive' ),
			'disable' => esc_html__( 'Disable', 'highresponsive' ),
		);
	    ...
	    <div id="highresponsive-ui-tabs" class="ui-tabs">
		    <ul class="highresponsive-ui-tabs-nav" id="highresponsive-ui-tabs-nav">
		    	<!-- <li><a href="#frag2"><?php esc_html_e( 'Select Sidebar', 'highresponsive' ); ?></a></li> -->
		    	<li><a href="#frag3"><?php esc_html_e( 'Header Featured Image Options', 'highresponsive' ); ?></a></li>
		    	<!-- <li><a href="#frag4"><?php esc_html_e( 'Single Page/Post Image Layout ', 'highresponsive' ); ?></a></li> -->
		    </ul>
...
$Highresponsive_Metabox = new Highresponsive_Metabox(
	...
	esc_html__( 'High Responsive Pro Options', 'highresponsive' ), //metabox title
