...
function highresponsive_custom_header_and_background() {
	...
	'default-image' => array(
		...
		'description'   => esc_html__( 'Default Header Image', 'highresponsive' ),
		),
	) );
}
...
function highresponsive_video_controls( $settings ) {
	$settings['l10n']['play'] = '<span class="screen-reader-text">' . esc_html__( 'Play background video', 'highresponsive' ) . '</span>' . highresponsive_get_svg( array(
		'icon' => 'play',
	) );
	$settings['l10n']['pause'] = '<span class="screen-reader-text">' . esc_html__( 'Pause background video', 'highresponsive' ) . '</span>' . highresponsive_get_svg( array(
		'icon' => 'pause',
	) );
	return $settings;
}
