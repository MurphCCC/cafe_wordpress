...
function highresponsive_scrollup() {
	...
	echo '<a href="#masthead" id="scrollup" class="backtotop">' .highresponsive_get_svg( array( 'icon' => 'angle-down' ) ) . '<span class="screen-reader-text">' . esc_html__( 'Scroll Up', 'highresponsive' ) . '</span></a>' ;
	...
	function highresponsive_content_nav() {
		...
		if ( 'numeric' === $pagination_type && function_exists( 'the_posts_pagination' ) ) {
			the_posts_pagination( array(
				'prev_text'          => esc_html__( 'Previous page', 'highresponsive' ),
				'next_text'          => esc_html__( 'Next page', 'highresponsive' ),
				'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'highresponsive' ) . ' </span>',
			) );
		} else {
...
function highresponsive_social_menu() {
	if ( has_nav_menu( 'social-menu' ) ) :
		?>
		<nav class="social-navigation" role="navigation" aria-label="<?php esc_html_e( 'Social Links Menu', 'highresponsive' ); ?>">
			<?php
				wp_nav_menu( array(
