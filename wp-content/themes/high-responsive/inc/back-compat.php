...
function highresponsive_upgrade_notice() {
	$message = sprintf( __( 'High Responsive requires at least WordPress version 4.4. You are running version %s. Please upgrade and try again.', 'highresponsive' ), $GLOBALS['wp_version'] );
...
function highresponsive_customize() {
	wp_die( sprintf( __( 'High Responsive requires at least WordPress version 4.4. You are running version %s. Please upgrade and try again.', 'highresponsive' ), $GLOBALS['wp_version'] ), '', array(
		'back_link' => true,
	) );// WPCS: XSS ok.
}
...
function highresponsive_preview() {
	if ( isset( $_GET['preview'] ) ) {
		wp_die( sprintf( __( 'High Responsive requires at least WordPress version 4.4. You are running version %s. Please upgrade and try again.', 'highresponsive' ), $GLOBALS['wp_version'] ) );// WPCS: XSS ok.
	}
}
