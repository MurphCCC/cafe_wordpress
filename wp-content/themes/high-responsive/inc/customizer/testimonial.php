...
function highresponsive_testimonial_options( $wp_customize ) {
    ...
    highresponsive_register_option( $wp_customize, array(
            ...
            'label'             => sprintf( esc_html__( 'For Testimonial Options for High Responsive Theme, go %1$shere%2$s', 'highresponsive' ),
    ...
    $wp_customize->add_section( 'highresponsive_testimonials', array(
            ...
            'title'    => esc_html__( 'Testimonials', 'highresponsive' ),
        )
    );
    ...
    highresponsive_register_option( $wp_customize, array(
            ...
            'label'             => sprintf( esc_html__( 'For Testimonial, install %1$sEssential Content Types%2$s Plugin with Testimonial Content Type Enabled', 'highresponsive' ),
    ...
    highresponsive_register_option( $wp_customize, array(
            ...
            'label'             => esc_html__( 'Check to Enable Slider', 'highresponsive' ),
            'section'           => 'highresponsive_testimonials',
            'type'              => 'checkbox',
        )
    );
    ...
    highresponsive_register_option( $wp_customize, array(
            ...
            'active_callback'   => 'highresponsive_is_testimonial_active',
            'label'             => esc_html__( 'Number of items to show', 'highresponsive' ),
            'section'           => 'highresponsive_testimonials',
            'type'              => 'number',
            'input_attrs'       => array(
                'style'             => 'width: 100px;',
   ...
   $number = get_theme_mod( 'highresponsive_testimonial_number', 3 );
    ...
    for ( $i = 1; $i <= $number ; $i++ ) {
        highresponsive_register_option( $wp_customize, array(
                ...
                'active_callback'   => 'highresponsive_is_testimonial_active',
                'label'             => esc_html__( 'Testimoial', 'highresponsive' ) . ' ' . $i ,
                'section'           => 'highresponsive_testimonials',
                'type'              => 'select',
