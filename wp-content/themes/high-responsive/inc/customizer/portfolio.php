...
function highresponsive_portfolio_options( $wp_customize ) {
    ...
    highresponsive_register_option( $wp_customize, array(
            ...
            'label'             => sprintf( esc_html__( 'For Portfolio Options for High Responsive Theme, go %1$shere%2$s', 'highresponsive' ),
    ...
    $wp_customize->add_section( 'highresponsive_portfolio', array(
            ...
            'title'    => esc_html__( 'Portfolio', 'highresponsive' ),
        )
    );
    ...
    highresponsive_register_option( $wp_customize, array(
            ...
            'label'             => sprintf( esc_html__( 'For Portfolio, install %1$sEssential Content Types%2$s Plugin with Portfolio Content Type Enabled', 'highresponsive' ),
    ...
    for ( $i = 1; $i <= $number ; $i++ ) {
        highresponsive_register_option( $wp_customize, array(
                ...
                'active_callback'   => 'highresponsive_is_portfolio_active',
                'label'             => esc_html__( 'Portfolio', 'highresponsive' ) . ' ' . $i ,
                'section'           => 'highresponsive_portfolio',
                'type'              => 'select',
