...
function highresponsive_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'highresponsive_reset_all', array(
		'description'   => esc_html__( 'Caution: Reset all settings to default. Refresh the page after save to view full effects.', 'highresponsive' ),
		'title'         => esc_html__( 'Reset all settings', 'highresponsive' ),
		'priority'      => 998,
	) );
	...
	highresponsive_register_option( $wp_customize, array(
			...
			'label'             => esc_html__( 'Check to reset all settings to default', 'highresponsive' ),
	...
	$wp_customize->add_section( 'highresponsive_important_links', array(
		'priority'      => 999,
		'title'         => esc_html__( 'Important Links', 'highresponsive' ),
	) );
	...
	highresponsive_register_option( $wp_customize, array(
			...
			'label'             => esc_html__( 'Important Links', 'highresponsive' ),
