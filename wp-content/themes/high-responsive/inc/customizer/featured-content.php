...
function highresponsive_featured_content_options( $wp_customize ) {
    ...
    highresponsive_register_option( $wp_customize, array(
            ...
            'label'             => sprintf( esc_html__( 'For More Featured Content Options for High Responsive Theme, go %1$shere%2$s', 'highresponsive' ),
    ...
    $wp_customize->add_section( 'highresponsive_featured_content', array(
			'title' => esc_html__( 'Featured Content', 'highresponsive' ),
	...
	highresponsive_register_option( $wp_customize, array(
            ...
            'label'             => sprintf( esc_html__( 'For Featured Content, install %1$sEssential Content Types%2$s Plugin with Testimonial Content Type Enabled', 'highresponsive' ),
	...
	highresponsive_register_option( $wp_customize, array(
            ...
            'label'             => sprintf( esc_html__( 'For CPT heading and sub-heading, go %1$shere%2$s', 'highresponsive' ),
	...
	highresponsive_register_option( $wp_customize, array(
			...
			'active_callback'   => 'highresponsive_is_featured_content_active',
			'description'       => esc_html__( 'Save and refresh the page if No. of Featured Content is changed (Max no of Featured Content is 20)', 'highresponsive' ),
			'input_attrs'       => array(
				'style' => 'width: 100px;',
				'min'   => 0,
			),
			'label'             => esc_html__( 'No of Featured Content', 'highresponsive' ),
			'section'           => 'highresponsive_featured_content',
			'type'              => 'number',
	...
	for ( $i = 1; $i <= $number ; $i++ ) {
		highresponsive_register_option( $wp_customize, array(
				...
				'active_callback'   => 'highresponsive_is_featured_content_active',
				'label'             => esc_html__( 'Featured Content', 'highresponsive' ) . ' ' . $i ,
				'section'           => 'highresponsive_featured_content',
				'type'              => 'select',
